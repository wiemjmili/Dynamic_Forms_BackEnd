...
public class UserTaskController {
	...
	public ResponseEntity<String> getUserTask(@PathVariable(value = "nameUT") String nameUT,
			@PathVariable(value = "nameWF") String nameWF) {
		try {
	...
	public ResponseEntity<UserTask> getUTById(@PathVariable(value = "idUT") String idUT) {
		try {
			return ResponseEntity.accepted().body(usertaskService.getUTById(idUT));
